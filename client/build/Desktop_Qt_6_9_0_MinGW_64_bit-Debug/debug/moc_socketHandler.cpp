...
void SocketHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SocketHandler::*)()>(_a, &SocketHandler::connected, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SocketHandler::*)(const QString & )>(_a, &SocketHandler::errorOccurred, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (SocketHandler::*)(const QString & )>(_a, &SocketHandler::messageReceived, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (SocketHandler::*)()>(_a, &SocketHandler::disconnected, 3))
            return;
    }
}
