...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        verticalLayoutWidget->setGeometry(QRect(9, 9, 381, 381));
        verticalLayout = new QVBoxLayout(verticalLayoutWidget);
        verticalLayout->setObjectName("verticalLayout");
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        horizontalLayout = new QHBoxLayout();
        horizontalLayout->setObjectName("horizontalLayout");
        lblPort = new QLabel(verticalLayoutWidget);
        lblPort->setObjectName("lblPort");

        horizontalLayout->addWidget(lblPort);

        ledPort = new QLineEdit(verticalLayoutWidget);
        ledPort->setObjectName("ledPort");

        horizontalLayout->addWidget(ledPort);
